...
/**
 * This method is for atributes with property type `object` with any number of values, eg. `content`, `url`, `type` etc.
 ...
 * Example `onChangeHeadingColor` where atribute name is `heading` and object property is `color`
 *
...
/**
 * This method is for atributes with single property.
...
/**
 * This method is for media atributes, it is property type `object` with default values of `id`, `url`, `title`.
